 ...
 * @typedef {{ id: string, label: string, description: string, plot?: Zone, pool?: Zone, ground?: string, items: PresetItem[] }} Preset
 */
...
export const PRESETS = [
  {
    ...
    description:
      "Un bassin de 8 × 4 m bordé de margelles, une terrasse dallée et des colonnes en fond de perspective. Les grands bacs plantés d'oliviers ferment l'espace sans l'enfermer.",
    ground: "dallage",
    pool: { width: 8, depth: 4, z: -1 },
    items: [
      { ref: "C400", x: -5, z: -3.4, finish: "blanc" },
      { ref: "C400", x: 5, z: -3.4, finish: "blanc" },
      { ref: "BS225", x: -5, z: 0, finish: "blanc", species: "olivier" },
      { ref: "BS225", x: 5, z: 0, finish: "blanc", species: "olivier" },
      { ref: "BANCSIMPLE", x: -2, z: 3.2, finish: "blanc" },
      { ref: "BANCSIMPLE", x: 2, z: 3.2, finish: "blanc" },
      { ref: "B800", x: 0, z: 3.4, finish: "blanc", species: "palmier" },
      { ref: "F22", x: 0, z: -5.4, finish: "blanc" },
    ],
  },
  {
    ...
    description:
      "Le même bassin, en version conviviale : table et tabourets à l'ombre d'un côté, barbecue à hotte de l'autre, jets d'eau muraux en accompagnement.",
    ground: "sable",
    pool: { width: 9, depth: 4.5, z: -2 },
    items: [
      { ref: "BARBACUE3", x: -6, z: 2.4, rotation: T / 2, finish: "gris" },
      { ref: "TABLE", x: 2.4, z: 2.8, finish: "blanc" },
      { ref: "TABOURET", x: 1, z: 2.8, rotation: T, finish: "blanc" },
      { ref: "TABOURET", x: 3.8, z: 2.8, rotation: T, finish: "blanc" },
      { ref: "F86", x: -2.6, z: -5.6, finish: "blanc" },
      { ref: "F86", x: 2.6, z: -5.6, finish: "blanc" },
      { ref: "B729", x: -0.2, z: 4.6, finish: "saumon", species: "graminee" },
      { ref: "B729", x: 5, z: 4.6, finish: "saumon", species: "graminee" },
    ],
  },
  {
    id: "terrain-cloture",
