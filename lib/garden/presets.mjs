 ...
 * @typedef {{ id: string, label: string, description: string, plot?: Zone, pool?: Zone, ground?: string, building?: string, buildingZ?: number, paving?: string, pavingArea?: Zone, items: PresetItem[], props?: PresetProp[] }} Preset
 */
...
export const PRESETS = [
  ...
  },
  {
    ...
    description:
      "La même villa, côté vivre : le barbecue adossé au mur, la table dressée à l'écart des projections, les jets muraux en fond de terrasse. Les graminées ferment le jardin d'un rideau léger qui bouge au moindre souffle.",
    ground: "sable",
    building: "villa",
    buildingZ: -8.5,
