...
export const PRESETS = [
  {
    ...
    description:
      "Un rectangle de bordures ajourées, 14 × 10 m, posé au cordeau. Dalles claires au centre, quatre oliviers en bacs aux angles, deux colonnes en fond de perspective. Le dessin tient parce que rien ne dépasse de l'alignement.",
    ground: "pelouse",
    paving: "DAL50R",
  ...
  },
  {
    ...
    description:
      "Table et bancs en gris, quatre bacs à lames qui ferment l'espace sans monter de mur. Les bordures basses retiennent le gravier — sans elles, il finit dans la pelouse. Pas de décor : la matière suffit.",
    ground: "gravier",
    paving: "DALBOIS",
  ...
  },
  {
    ...
    description:
      "Deux paires de colonnes tiennent l'allée dallée, 3,20 m de large. De part et d'autre, six vasques de buis espacées de 1,60 m donnent la cadence jusqu'au perron. Quatre lanternes hautes pour le soir.",
    ground: "dallage",
    building: "villa",
    buildingZ: -9.5,
    paving: "DALHUIT",
  ...
  },
  {
    ...
    description:
      "Six mètres sur cinq, dallage à motif tapis sur lit de sable. Deux bancs face à face, une table basse, un parasol, des pots de succulentes qui supportent le plein soleil. Deux veilleuses basses pour la fin de journée.",
    ground: "sable",
    paving: "DALTAPIS",
  ...
  },
  {
    ...
    description:
      "Le puits au centre, avec trois mètres de dégagement — c'est ce vide qui le fait exister. Géraniums et lavande autour, un chemin de pas japonais dans l'herbe, et la niche à l'écart du passage, contre le mur.",
    ground: "pelouse",
    items: [
  ...
  },
  {
    ...
    description:
      "Douze mètres sur douze, pavage à motif tapis, fontaine au centre. Deux jets muraux se répondent d'un mur à l'autre — dans une cour close, l'eau couvre le bruit de la rue. Palmiers et yuccas aux angles, deux colonnes lumineuses au fond.",
    ground: "sable",
    paving: "DALTAPIS",
  ...
  },
  {
    ...
    description:
      "Bassin de 9 × 4,50 m devant la villa, margelles claires, dallage tout autour. Les oliviers en bacs tiennent la ligne des baies, les bancs sont reculés de deux mètres — assez pour ne pas recevoir les éclaboussures. Un chemin de pierre file vers la fontaine du fond.",
    ground: "dallage",
    building: "villa",
    buildingZ: -8.5,
    paving: "DAL50R",
  ...
  },
  {
    ...
    description:
      "La même villa, côté vivre, en fin de soirée. Barbecue adossé au mur plein, table à deux mètres du foyer, jets muraux en fond de terrasse. Deux grandes veilleuses à treillis posent leur damier au sol, les graminées ferment le jardin sans le boucher.",
    nuit: true,
    ground: "sable",
    building: "villa",
    buildingZ: -8.5,
  ...
  },
  {
    ...
    description:
      "Maison de plain-pied, parcelle de 16 × 14 m ceinturée de piquets à 1,60 m et de leur grillage. Allée de pas japonais dans l'herbe, puits d'un côté, barbecue de l'autre, niche orientée au soleil du matin.",
    ground: "pelouse",
    building: "maison",
    buildingZ: -3.5,
    items: [
  ...
  },
  {
    ...
    description:
      "Huit mètres sur six de terre franche, piquets tous les 1,60 m, grillage tendu ensuite. Les bacs et la vasque attendent les plants. C'est l'ordre des choses : la limite d'abord, le remplissage après.",
  ...
  },
  {
    ...
    description:
      "Table de 155 cm, deux bancs et deux tabourets : six couverts, avec 70 cm de passage derrière chaque assise. Deux grands bacs d'oliviers pour l'ombre, bordures ajourées en contour, gravier au sol.",
    ground: "gravier",
    items: [
      ...ajouree(9, 7),
      { ref: "TABLE", x: 0, z: 0, finish: "gris" },
  ...
  },
  {
    ...
    description:
      "Six mètres sur six, pavage brique. Sept pièces en tout : des pots ronds groupés, un bac contre le mur, un palmier nain qui prend la hauteur. Blanc et rouge terre alternés. À cette échelle, une pièce de plus ferait encombré.",
    ground: "sable",
    paving: "DALBRIQUE",
  ...
  },
  {
    ...
    description:
      "Huit lanternes hautes, quatre de chaque côté, tous les 2,60 m : à cette distance les halos se touchent et l'allée se lit d'un bout à l'autre. Les deux grandes veilleuses marquent l'entrée, la lavande borde le passage. Allée de 3 m, dallage huit faces.",
    ground: "pelouse",
    building: "villa",
    buildingZ: -10.5,
    paving: "DALHUIT",
